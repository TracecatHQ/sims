from sims.scenarios.codebuild_secrets import (
    tf_script as codebuild_secrets_tf_script,
)
from sims.scenarios.detection_evasion import (
    tf_script as detection_evasion_tf_script,
)
from sims.scenarios.ec2_ssrf import tf_script as ec2_ssrf_tf_script
from sims.scenarios.ecs_efs_attack import tf_script as ecs_efs_attack_tf_script
from sims.scenarios.iam_privesec_by_attachment import (
